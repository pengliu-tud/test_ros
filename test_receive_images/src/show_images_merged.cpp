...
//    message_filters::Subscriber<sensor_msgs::Image> sub_right(nh, "/stereo/right/image_raw", 100);
    ...
    message_filters::Subscriber<sensor_msgs::Image> sub_left(nh, "/mypublisher/left", 100);
    message_filters::Subscriber<sensor_msgs::Image> sub_right(nh, "/mypublisher/right", 100);
